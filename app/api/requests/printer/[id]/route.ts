...
import { updatePrinterRequestStatus } from '@/lib/queries'
...
export async function PATCH(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    const changes = await updatePrinterRequestStatus(id, status, reason)
    ...
    console.error('[/api/requests/printer/[id]] PATCH error:', err)
